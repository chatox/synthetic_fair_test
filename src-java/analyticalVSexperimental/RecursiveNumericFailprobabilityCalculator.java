...
public class RecursiveNumericFailprobabilityCalculator extends FailprobabilityCalculator {
    ...
    private static double EPS = 0.0000000000000001;
    ...
    private MTableFailProbPair computeBoundary(int k, double p, double alpha) {
        int[] mTable = new MTableGenerator(k, p, alpha).getMTable();
    ...
    private double findLegalAssignmentsAux(int numCandidates, ArrayList<Integer> blockSizes, int currentBlockNumber, int candidatesAssignedSoFar) {
