...
def main():
    data = pd.read_csv("../../src-java/multinomial/data/GermanCredit/german.data", sep=" ")
    ...
    data.to_csv("../../src-java/multinomial/data/GermanCredit/germanCredit_sexAgeForeigner.csv", header=True, index=False)
