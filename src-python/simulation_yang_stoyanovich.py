...
def writeMTableToCSV(k, p, alpha):
    ...
    with open("C:\\Users\\TSuehr\\Documents\\synthetic_fair_test\\csvFiles\\csv-python\\" + filename,
              "w") as csv_file:
...
def writeRankingToCSV(k, p, alpha):
    ...
    with open("C:\\Users\\TSuehr\\Documents\\synthetic_fair_test\\csvFiles\\csv-python\\"
              + filename,
              "w") as csv_file:
        writer = csv.writer(csv_file, delimiter=';')
